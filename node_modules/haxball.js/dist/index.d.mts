...
interface StadiumObject {
  ...
  */
  traits?: Record<string, Partial<Vertex & Segment & Goal & Plane & Disc & Joint>>;
...
declare class InvalidRoomTokenError extends Error {
  constructor();
}
//#endregion
...
//#endregion
export { BackgroundObject, CollisionFlagsObject, Disc, DiscPropertiesObject, Goal, HBInit, type HaxballJSConfig, InvalidRoomTokenError, Joint, Plane, PlayerJoinObject, PlayerObject, PlayerPhysics, RoomConfigObject, RoomObject, ScoresObject, Segment, StadiumObject, TeamID, Vertex, type WebRTCImplementation, HaxballJS as default };